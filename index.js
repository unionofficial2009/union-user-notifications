...
bot.on('guildMemberUpdate', (oldMember, newMember) => {
  ...
  if(newaddedrole=="Verified"){
   ...
   newMember.send(botembed);
    ...
    let botembed = new Discord.RichEmbed()
        .setDescription("Hello maam/sir welcome to UNION.")
        .addField("Instructions", "Please proceed to <#498095783392837632> channel in the **UNION HEADQUATERS** discord server. Kindly tag the following : **@LS - Leader @LS - Deputy  @LS - Elite @UNION Officers @UNION Human Resources** in the <#608172592934813724>.")
        .addField("Need Help?", "Any problem, please DM **@UNION President @UNION Vice President @UNION Officers @UNION Human Resources @LS - Leader @LS - Deputy  @LS - Elite**.")
        .setColor("#15f153")
        .setTimestamp()
        .setFooter("UNION User Notifications",bicon2);
