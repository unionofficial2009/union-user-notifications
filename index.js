...
bot.on('guildMemberAdd', member => {
   ...
   let botembed = new Discord.RichEmbed()
        ...
        .addField("Instructions", "Please proceed to **#welcome** channel in the **UNION HEADQUATERS** discord server. Kindly read and follow the rules and instructions on the **welcome** channel to access the channels for specific game.")
