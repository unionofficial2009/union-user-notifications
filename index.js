...
bot.on('guildMemberAdd', member => {
   ...
   let botembed = new Discord.RichEmbed()
        ...
        .addField("Instructions", "Please proceed to **#welcome** channel in the **UNION HEADQUATERS DISCORD SERVER** and kindly read and follow the rules and instructions below to access the channels for specific game.")
